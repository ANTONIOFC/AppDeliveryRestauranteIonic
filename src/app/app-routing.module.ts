...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        loadChildren: () => import('./delivery/delivery-list/delivery-list.module')
                              .then( m => m.DeliveryListPageModule)
      },
      {
        path: 'new',
        loadChildren: () => import('./delivery/delivery-edit/delivery-edit.module')
                            .then( m => m.DeliveryEditPageModule)
      },
      {
        path: 'edit/:id',
        loadChildren: () => import('./delivery/delivery-edit/delivery-edit.module')
